...
export const NLM = (() => {
	...
	style.textContent = [
		...
		".nlm-search{width:100%;box-sizing:border-box;padding:7px 10px;margin:6px 0 8px;border-radius:var(--radius-md);border:1px solid var(--edge-soft);background:var(--input-bg);color:var(--text);font-size:13.5px}",
		".nlm-quickrow{display:flex;gap:6px;flex-wrap:wrap;margin-bottom:6px;align-items:center}",
		".nlm-quickrow button{font-size:12px;padding:3px 9px;border-radius:var(--radius-pill);background:var(--surface);border:1px solid var(--edge-soft);color:var(--text2);cursor:pointer}",
		".nlm-quickrow button:hover{background:var(--surface-hover);color:var(--text)}",
		".nlm-list{max-height:44vh;overflow:auto;border:1px solid var(--edge-soft);border-radius:var(--radius-md);padding:3px 0;background:var(--surface-faint)}",
		".nlm-row{display:flex;align-items:center;gap:2px;padding:1px 6px}",
		".nlm-toggle{flex:none;width:18px;height:26px;display:flex;align-items:center;justify-content:center;font-size:10px;opacity:.55;cursor:pointer;border-radius:var(--radius-xs);user-select:none}",
		".nlm-toggle:hover{opacity:1;background:var(--surface-active)}",
		".nlm-toggle-empty{cursor:default;visibility:hidden}",
		".nlm-check{display:flex;align-items:center;gap:10px;flex:1;min-width:0;padding:7px 9px;border-radius:var(--radius-md);cursor:pointer;user-select:none;color:var(--text)}",
		".nlm-check:hover{background:var(--surface-hover)}",
		".nlm-check.nlm-picked{background:var(--accent-soft)}",
		...
		".nlm-checkmark{flex:none;width:18px;height:18px;min-width:18px;border-radius:var(--radius-xs);border:1.5px solid var(--edge);display:flex;align-items:center;justify-content:center;font-size:12px;line-height:1;color:transparent;transition:background .12s,border-color .12s,color .12s}",
		".nlm-check.nlm-picked .nlm-checkmark{background:var(--accent);border-color:var(--accent);color:var(--on-accent)}",
		".nlm-row.nlm-cur .nlm-title{font-weight:600}",
		".nlm-tag{display:inline-block;font-size:10px;opacity:.9;background:var(--accent-soft);color:var(--accent);padding:1px 7px;border-radius:var(--radius-pill);margin-left:7px;vertical-align:middle}",
		".nlm-empty{padding:14px;text-align:center;color:var(--text2);font-size:13px}",
		".nlm-count{color:var(--text2);font-size:12.5px;margin-left:auto}",
		// Inbox-Toast (unten rechts)
		".nlm-inbox-toast{position:fixed;right:16px;bottom:16px;z-index:9999;background:var(--menu-bg);color:var(--text);border:1px solid var(--edge);border-radius:var(--radius-lg);padding:12px 14px;box-shadow:var(--elev-3);max-width:320px;font-size:13px}",
		".nlm-inbox-toast .nlm-it-title{font-weight:650;margin-bottom:2px}",
		".nlm-inbox-toast .nlm-it-name{color:var(--text2);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:290px}",
		".nlm-inbox-toast .nlm-it-src{color:var(--text2);font-size:12px;margin-top:2px}",
		".nlm-inbox-toast .nlm-it-btns{display:flex;gap:6px;margin-top:8px}",
		".nlm-inbox-toast button{font-size:12.5px;padding:4px 10px;border-radius:var(--radius-sm);border:1px solid var(--edge-soft);background:var(--surface);color:var(--text);cursor:pointer}",
		".nlm-inbox-toast button:hover{background:var(--surface-hover)}",
		".nlm-inbox-toast button.nlm-it-primary{background:var(--accent);border-color:var(--accent);color:var(--on-accent)}",
		// Einordnen-Dialog
		".nlm-place-list{display:flex;flex-direction:column;gap:6px;margin:10px 0}",
		".nlm-place-opt{text-align:left;padding:10px 12px;border-radius:var(--radius-md);border:1px solid var(--edge-soft);background:var(--surface);color:var(--text);cursor:pointer;font-size:13.5px}",
		".nlm-place-opt:hover{background:var(--accent-soft);border-color:var(--accent)}",
		...
		".nlm-drop{border:2px dashed var(--edge);border-radius:var(--radius-lg);padding:26px 18px;text-align:center;color:var(--text2);font-size:13.5px;margin:6px 0 22px;transition:border-color .12s,background .12s,opacity .12s}",
		".nlm-drop.drag{border-color:var(--accent);background:var(--accent-soft);color:var(--accent);opacity:1}",
